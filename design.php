    ...
    <div class="hero-wrap">
      <div class="hero-content">
        ...
        <div class="hero-btn button">
          <a href="<?php the_sub_field('button-link'); ?>" class="button-link"><?php the_sub_field('button-name'); ?></a>
          <div class="arrows">
            <svg class="arrows-icon icon1 d-hero-icon">
              <use xlink:href="<?php echo get_template_directory_uri();?>/assets/img/sprite.svg#a-left"></use>
            </svg>
            <svg class="arrows-icon icon2 d-hero-icon">
              <use xlink:href="<?php echo get_template_directory_uri();?>/assets/img/sprite.svg#a-left"></use>
            </svg>
            <svg class="arrows-icon icon3 d-hero-icon">
              <use xlink:href="<?php echo get_template_directory_uri();?>/assets/img/sprite.svg#a-left"></use>
            </svg>
          </div>
        </div>
  ...
  <div class="container">
    ...
    <div class="packages-wrap">
      ...
      <div class="packages-cart">
        <div class="packages-cart-wrap">
          <h6 class="packages-cart-title"><?php the_sub_field('cart-name'); ?></h6>
          <p class="packages-cart-price"><?php the_sub_field('price'); ?></p>
          <div class="packages-list"><?php the_sub_field('list'); ?></div>
        </div>
...
<section class="advantages">
  <div class="container">
    ...
    <div class="advantages-wrap">
      ...
      <div class="advantages-cart1 advantages-cart">
        <img class="advantages-img1" src="<?php echo get_template_directory_uri();?>/assets/img/adv-bg1.webp" alt="bg1">
        <img class="advantages-img2"src="<?php echo get_template_directory_uri();?>/assets/img/adv-des-bg1.webp" alt="bg1">
        <p class="advantages-cart-title1"><?php the_sub_field('cart-title_1'); ?></p>
      </div>
      <div class="advantages-cart2 advantages-cart">
        <img src="<?php echo get_template_directory_uri();?>/assets/img/adv-bg2.webp" alt="bg2">
        <p class="advantages-cart-title2"><?php the_sub_field('cart-title_2'); ?></p>
      </div>
      <div class="advantages-cart3 advantages-cart">
        <img src="<?php echo get_template_directory_uri();?>/assets/img/adv-bg3.webp" alt="bg3">
        <p class="advantages-cart-title3"><?php the_sub_field('cart-title_3'); ?></p>
      </div>
      <div class="advantages-cart4 advantages-cart">
        <img src="<?php echo get_template_directory_uri();?>/assets/img/adv-bg4.svg" alt="bg4">
        <p class="advantages-cart-title4"><?php the_sub_field('cart-title_4'); ?></p>
      </div>
    </div>
  </div>
</section>
...
<section class="operation">
  <div class="operation-back">
    ...
    <div class="logo-str operation-str">
      <div class="logo-wrap">
        <svg class="logo-icon oper-logo-icon">
          <use xlink:href="<?php echo get_template_directory_uri();?>/assets/img/logo-frame.svg#logo-frame"></use>
        </svg>
      </div>
    </div>
