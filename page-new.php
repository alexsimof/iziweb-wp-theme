...
if (have_rows('main', 2)): 
  ...
  while (have_rows('main', 2)): the_row();
...
<?php 
  ...
  if (have_rows('conditions', 2)): while(have_rows('conditions', 2)): the_row();
...
<?php 
  if (have_rows('services', 2)): while(have_rows('services', 2)): the_row();
?>
...
<?php 
  ...
  if( have_rows('projects',2) ): while( have_rows('projects',2) ): the_row();
            ...
            <div class="project-item-wrap">
              ...
              <div class="project-item-header">
                ...
                <div class="project-item-text text-<?php echo $i; ?>">
                  ...
                  <a href="<?php the_permalink();?>"  class="project-item-link link-<?php echo $i; ?>"><?php the_sub_field('pro-link'); ?></a>
...
<?php 
  ...
  if( have_rows('blog',2) ): while( have_rows('blog',2) ): the_row();
...
<?php 
  ...
  if( have_rows('seo',2) ): while( have_rows('seo',2) ): the_row();
